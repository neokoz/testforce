cucumber-java-selenium (with some page objects)
==================
...
- In Chrome search on 'Chrome CSS Selector' and add the extension to your browser
...
- Fill in URL "https://github.com/neokoz/testforce.git"
- press Test
- press Clone
